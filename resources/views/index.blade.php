...
<html lang="en">
  <head>
    ...
    <title>SSMP Dashboard</title>
    <!-- base:css -->
    <link  href={{ asset('template/vendors/typicons.font/font/typicons.css') }} rel="stylesheet" >
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="ui-basic">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link"  href="../template/pages/prodcuts/createproduct.html">Crewte Prodcut</a></li>
                <li class="nav-item"> <a class="nav-link" href="../template/pages/prodcuts/showproducts.html">Show Products</a></li>
                <li class="nav-item"> <a class="nav-link" href="../template/pages/prodcuts/invoice.html">Create Invoice</a></li>
              </ul>
            </div>
          </li>
          <li class="nav-item">
                ...
                <div class="card">
                  <div class="card-body">
                    <div class="d-flex flex-wrap justify-content-between">
                      <h4 class="card-title mb-3">Sales By Vendor</h4>
                    </div>
                    <div class="row">
                      <div class="col-12">
                        <div class="row">
                          ...
                          <div class="col-lg-6">
                            <ul class="session-by-channel-legend">
                              ...
                              <li>
                                <div>Distributeres</div>
                                <div>12(100%)</div>
                              </li>
                              <li>
                                <div>Drirect Customer</div>
                                <div>2(100%)</div>
                              </li>
                              <!-- <li>
                                <div>Firewalls(3)</div>
